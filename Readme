Please refer to [VeritestingTransformations](https://github.com/sohah/VeritestingTransformations) for the latest code that adds path-merging to Symbolic PathFinder.
