...
public class tcasv {
	...
	public static boolean need_upward_RA = false;
	public static boolean need_downward_RA = false;
...
/*		assert((Up_Separation > alim &&
		...
		assert((Up_Separation < alim &&
				Down_Separation >= alim) ? 
					result != need_Upward_RA : true);
					
		assert((Up_Separation >= alim &&
				Down_Separation < alim) ? 
					result != need_Downward_RA);
*/
					// Original properties
